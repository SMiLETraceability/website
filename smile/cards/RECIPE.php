...
-->
            ...
            <div class="panel panel-default" id="activity_<?php echo $item->{'id'}?>">
                ...
                <div class="panel-body">
                <?php if ($page === "product") { ?>
                   <a href="#" data-label="How to use this product?" data-activity-id="<?php echo $item->{'id'} ?>" class="btn btn-danger btn-xs active" role="button" style="float:right;margin-left:5px; margin-right:5px;" data-toggle="modal" data-target="#confirm-delete-activity">Remove</a>        
                   <a href="#" data-activity-id="<?php echo $item->{'id'} ?>" class="btn btn-primary btn-xs active" role="button" style="float:right;margin-left:5px; margin-right:5px;" data-toggle="modal" data-target="#edit-recipe">Edit</a>        
