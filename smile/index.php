...
<div class="container">
  ...
  <div class="panel panel-info">
    ...
    <div class="row">
       <div class="col-md-1"><span class="glyphicon glyphicon-qrcode largeicon"></span></div>
       <div class="col-md-11"><p>The producer can create individual items and TrackMyFood generates a unique code which can be applied to the exiting food packaging. The consumer can use this code to retrieve all the information about the item via a free mobile phone App.</p></div>
     </div>
  ...
  <div class="panel panel-info">
    ...
    <div class="row">
       <div class="col-md-1"><span class="glyphicon glyphicon-info-sign largeicon"></span></div>
       <div class="col-md-11"><p>TrackMyFood has been developed by researchers of the University of Aberdeen as part of the SMiLE project. This is one of the projects of the <a href="http://www.dotrural.ac.uk/"> dot.rural RCUK digital economy Hub</a> which focusing on the rural digital economy.</p></div>
     </div>  
